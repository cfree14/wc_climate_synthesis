...
# Plot 
g1 <- ggplot(stock_key, aes(x=bbmsy_prod, y=theta_random)) +
  # LM fit
...
# Plot 
g2 <- ggplot(stock_key, aes(x=ffmsy_prod, y=theta_random)) +
  # LM fit
  geom_smooth(method="lm", fill="grey80", color="black") +
  # Reference lines
  geom_hline(yintercept=0) +
...
# Plot 
g3 <- ggplot(stock_key, aes(x=sst_c_trend_prod*10, y=theta_random)) +
  # LM fit
  geom_smooth(method="lm", fill="grey80", color="black") +
  # Reference lines
  geom_hline(yintercept=0) +
