...
# Directories
indir <- "data/landings/cdfw/public/fish_bulletins/raw/fb161/raw"
outdir <- "data/landings/cdfw/public/fish_bulletins/raw/fb161/processed"
plotdir <- "data/landings/cdfw/public/fish_bulletins/raw/fb161/figures"
...
data_full <- data_orig %>%
  ...
  mutate(species=gsub("[[:punct:]]", "", species),
         ...
         species=recode(species, 
                        ...
                        'All other specie'='All other species', 
                        'All specie'='All species', 
                        'All species'='All species', 
                        'Arrow tooth Bounder'='Arrowtooth flounder', 
                        ...
                        'Dungencss crab'='Dungeness crab', 
                        'English ole'='English sole', 
                        'English soe'='English sole', 
                        'Green abalonc'='Green abalone', 
                        'Itockfish'='Rockfish', 
                        'Miscellaneous animal food'='Miscellaneous (animal food)', 
                        'Ocean shrimp'='Pink (ocean) shrimp', 
                        'Pacific bom to'='Pacific bonito', 
                        ...
                        'W hitc croaker'='White croaker', 
                        'White abalonc'='White abalone', 
...
# Export data
write.csv(data, file=file.path(outdir, "FB161_Tables16-21_1972_landings_by_port.csv"), row.names=F)
