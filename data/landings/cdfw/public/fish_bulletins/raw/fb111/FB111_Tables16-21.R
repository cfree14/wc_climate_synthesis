...
# Directories
indir <- "data/landings/cdfw/public/fish_bulletins/raw/fb111/raw"
outdir <- "data/landings/cdfw/public/fish_bulletins/raw/fb111/processed"
plotdir <- "data/landings/cdfw/public/fish_bulletins/raw/fb111/figures"
...
data_full <- data_orig %>%
  ...
  mutate(species=gsub("[[:punct:]]", "", species),
         ...
         species=recode(species, 
                        ...
                        'Dover solo'='Dover sole',
                        'Giant Pacific oysterC'='Giant Pacific oyster', 
                        'Hockfish'='Rockfish', 
                        'I loundor'='Flounder', 
                        'Lingrod'='Lingcod', 
                        'Pacific herrinR'='Pacific herring', 
                        'Pctralcsolc'='Petrale sole', 
                        'Pctrale sole'='Petrale sole', 
                        'Petralc sole'='Petrale sole', 
                        'Petralesole'='Petrale sole', 
                        'W hite croaker'='White croaker', 
...
# Export data
write.csv(data_full, file=file.path(outdir, "FB111_Tables16-21_1959_landings_by_port.csv"), row.names=F)
