...
# Directories
indir <- "data/landings/cdfw/public/fish_bulletins/fb154/raw"
outdir <- "data/landings/cdfw/public/fish_bulletins/fb154/processed"
plotdir <- "data/landings/cdfw/public/fish_bulletins/fb154/figures"
...
# Export data
write.csv(data, file=file.path(outdir, "FB154_Tables16-21_1970_landings_by_port.csv"), row.names=F)
