...
# Merge data
data_orig <- readxl::read_excel(file.path(indir, "Tables24-30.xlsx"))
...
data_full <- data_orig %>%
  ...
  mutate(port_complex=recode(table,
                             "Table 24"="Eureka",
                             "Table 25"="Sacramento Delta",
                             "Table 26"="San Francisco",
                             "Table 27"="Monterey",
                             "Table 28"="Santa Barbara",
                             "Table 29"="Los Angeles",
                             "Table 30"="San Diego")) %>% 
  ...
  mutate(species=gsub("[[:punct:]]", "", species),
         ...
         species=recode(species, 
                        ...
                        'Broad bill swordfish'='Broadbill swordfish', 
                        'Ellowtail'='Yellowtail', 
                        'Hock fish'='Rockfish', 
                        'Iingcod'='Lingcod', 
                        'Jiiircod'='Lingcod', 
                        'Kinrfish'='Kingfish', 
                        'Pacigc mackerel'='Pacific mackerel', 
                        'Peich'='Perch', 
                        'Sablcfish'='Sablefish', 
                        'Sand dab'='Sanddab', 
                        'Soulpin'='Sculpin', 
                        'Spiny lolistcr'='Spiny lobster', 
                        'Spiny lotxster'='Spiny lobster', 
                        'Vll other'='All other species', 
...
# Export data
write.csv(data, file=file.path(outdir, "FB80_Tables24-30_1948_landings_by_port.csv"), row.names=F)
