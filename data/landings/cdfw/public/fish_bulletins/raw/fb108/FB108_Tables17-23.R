...
# Files to merge
files2merge <- paste0("Table", 17:23, ".xlsx")
...
data_full <- data_orig %>%
  ...
  mutate(port_complex=recode(table,
                             "Table 17"="Eureka",
                             "Table 18"="Sacramento Delta",
                             "Table 19"="San Francisco",
                             "Table 20"="Monterey",
                             "Table 21"="Santa Barbara",
                             "Table 22"="Los Angeles",
                             "Table 23"="San Diego")) %>% 
  ...
  mutate(species=gsub("[[:punct:]]", "", species),
         ...
         species=recode(species, 
                        ...
                        'alifortil barracuda'='California barracuda', 
                        'All other'='All other species', 
                        'arp'='Carp', 
                        'Bigeyc tuna'='Bigeye tuna', 
                        'Bimoyc tuna'='Bigeye tuna', 
                        'Bluetin tuna'='Bluefin tuna', 
                        'California immpano'='California pompano', 
                        'ellowfin tuna'='Yellowfin tuna', 
                        'English solo'='English sole', 
                        'Hay shrimp'='Bay shrimp', 
                        'Iingcod'='Lingcod', 
                        'Koekfish'='Rockfish', 
                        'llounder'='Flounder', 
                        'Pctrale sole'='Petrale sole', 
                        'Pismoclam'='Pismo clam', 
                        'Pisnio clam'='Pismo clam', 
                        'Rock fish'='Rockfish', 
                        'Roekfish'='Rockfish', 
                        'Spinv lobster'='Spiny lobster', 
                        'Spiny Lobster'='Spiny lobster', 
                        'Spiny loljster'='Spiny lobster', 
                        'Totab'='Totals', 
