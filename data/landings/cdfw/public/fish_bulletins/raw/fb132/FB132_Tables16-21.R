...
# Directories
indir <- "data/landings/cdfw/public/fish_bulletins/raw/fb132/raw"
outdir <- "data/landings/cdfw/public/fish_bulletins/raw/fb132/processed"
plotdir <- "data/landings/cdfw/public/fish_bulletins/raw/fb132/figures"
...
data_full <- data_orig %>%
  ...
  mutate(species=gsub("[[:punct:]]", "", species),
         ...
         species=recode(species, 
                        ...
                        'All other speeies'='All other species', 
                        'Blur fin tuna'='Bluefin tuna', 
                        'Flyinfish'='Flyingfish', 
                        'Fnglish sole'='English sole', 
                        'Hock fish'='Rockfish', 
                        'Miscellaneous animal food'='Miscellaneous (animal food)', 
                        'Miscellanesou animal food'='Miscellaneous (animal food)', 
                        'Pacific ompano'='Pacific pompano', 
                        'Pet rale sole'='Petrale sole', 
                        'Rock fish'='Rockfish', 
                        'Rook fish'='Rockfish', 
                        # 'Shad'='American shad', 
                        # 'Skipjack'='Black skipjack tuna', 
                        # 'Sturgeon'='NA', 
                        'White eroaker'='White croaker', 
...
# Export data
write.csv(data_full, file=file.path(outdir, "FB132_Tables16-21_1964_landings_by_port.csv"), row.names=F)
