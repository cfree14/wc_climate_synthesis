...
# Directories
indir <- "data/landings/cdfw/public/fish_bulletins/fb170/raw"
outdir <- "data/landings/cdfw/public/fish_bulletins/fb170/processed"
plotdir <- "data/landings/cdfw/public/fish_bulletins/fb170/figures"
...
# Check common names
spp_suggestions <- wcfish::check_names(data_full$species)
...
# Export data
write.csv(data, file=file.path(outdir, "FB170_Tables16-21_1976_landings_by_port.csv"), row.names=F)
