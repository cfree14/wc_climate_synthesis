...
# Directories
indir <- "data/landings/cdfw/public/fish_bulletins/fb166/raw"
outdir <- "data/landings/cdfw/public/fish_bulletins/fb166/processed"
plotdir <- "data/landings/cdfw/public/fish_bulletins/fb166/figures"
...
# Export data
write.csv(data, file=file.path(outdir, "FB166_Tables16-21_1974_landings_by_port.csv"), row.names=F)
