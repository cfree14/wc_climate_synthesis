...
ca1_orig <- readxl::read_excel(file.path(datadir, "ALL006-California-1980---2021-All-Views.xlsx"), 
                               sheet=2, skip=2, na=c("*", "-")) # landed units
# ca2_orig <- readxl::read_excel(file.path(datadir, "ALL006-California-1980---2021-All-Views.xlsx"), sheet=4) # all units
